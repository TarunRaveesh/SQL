...
--                              '_' - (ONLY ONE CHARACTER)) USE LIKE KEYWORD
SELECT * FROM WORKER WHERE FIRST_NAME LIKE '%i%'; -- Contains 'i'
SELECT * FROM WORKER WHERE FIRST_NAME LIKE '_a%'; -- SECOND CHARACTER IS 'a'
...
SELECT * FROM WORKER ORDER BY SALARY DESC LIMIT 5; -- TOP 5 SALARIES

-- DISTINCT VALUES
SELECT DEPARTMENT FROM WORKER; -- Includes DUPLICATES
SELECT DISTINCT DEPARTMENT FROM WORKER; -- UNIQUE DEPARTMENTS
